...
const HomeBanner = () => {
  return (
    <>
      <div className="homeBanner row m-0 p-0 align-items-center justify-content-center ">
        <div className="col-12">
          <h1 className="text-light ">THE BEST SELECTION OF WATCHES BANDS</h1>
          <button className="shopNow btn btn-lg text-light w-auto">
            Shop Now
          </button>
        </div>
      </div>
      <div className="homeBanner-lower row m-0 p-0">
        <div className="col-6 col-md-3 d-flex align-items-center justify-content-center">
          ...
          <p className="m-0 p-0 text-light fs-5 w-auto">Over 1 Million Straps Sold</p>
        </div>
        <div className="col-6 col-md-3 d-flex align-items-center justify-content-center">
          <i class="bi bi-headset text-light fs-2 m-0 p-0 pe-2"></i>
          <p className="m-0 p-0 text-light fs-5 w-auto">24/7 Customer Support</p>
        </div>
        <div className="col-6 col-md-3 d-flex align-items-center justify-content-center">
